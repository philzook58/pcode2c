...
void mymin(CPUState *state, size_t breakpoint)
{
	...
	for (;;)
	{
		...
		case 0x00100004:
			...
			printf("of %hhu\n", *(reg + 0x20b));
			INT_SUB(unique + 0x26200, 8, unique + 0x26100, 8, reg + 0x38 /* RDI */, 8);
			printf("rdi %ld\n", *(reg + 0x38));
			printf("sub %ld\n", *(unique + 0x26200));									  // (unique, 0x26200, 8) INT_SUB (unique, 0x26100, 8) , (register, 0x38, 8)
